...
use App\Models\AlimentoSistema;

/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\AlimentoSistema>
 */
class AlimentoSistemaFactory extends Factory
{
    /**
    ...
    protected $model = AlimentoSistema::class;
